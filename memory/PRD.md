...
- 2026-06 : **Highlight filtres v2** : appliqué aux boutons (et pas seulement aux Select) sur Planning global : sélecteurs de promo (Toutes / Promo X) + sélecteurs de jours (Lun/Mar/Mer/Jeu/Ven). Formule corrigée pour `heures_par_etudiant` : `Σ heures par groupe ÷ nb de groupes de la promo` (au lieu du dédoublonnage par créneau qui ne reflétait pas correctement la réalité élève).
