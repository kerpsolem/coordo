...
- 2026-06 : **Alerte "Séance incomplète"** ajoutée : pour chaque séance de type cours (is_cours=true, hors TPG) où `formateur_ids < nb_formateurs_requis`, une alerte de catégorie `incomplet` est levée avec message détaillé "X formateur(s) sur Y requis (manque Z)". Filtre frontend ajouté dans /alertes avec icône Users orange.
